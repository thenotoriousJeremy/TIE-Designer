...
#include "Materials/Material.h" // Added include for material constants
...
namespace UnrealSTL
{
	...
	// Use a compatible method for GPU to CPU transfer in Unreal Engine 5.4
	...
	{
		// FRDGBuffer implementation or equivalent readback mechanism for Unreal Engine 5
	}
#else
	template<typename ReturnType, typename RHIResource>
	static void GPUToCPU(TArray<ReturnType>& Data, RHIResource Resource, const int32 NumElements)
